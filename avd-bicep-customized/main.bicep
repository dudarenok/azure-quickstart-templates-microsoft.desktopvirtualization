...
param vmAdminPassword string = 'LILA)2j(!3mu/15'
...
param numberOfSessionHost int = 1
...
var hostPoolProperties = {
  ...
  hostPoolType: 'Pooled'//fslogixEnabled ? 'Pooled' : 'Personal'
  // personalDesktopAssignmentType: fslogixEnabled ? '' : 'Direct'
  maxSessionLimit: 999999
  loadBalancerType: 'BreadthFirst'//fslogixEnabled ? 'BreadthFirst' : 'Persistent'
  ...
  registrationInfo: {
    expirationTime: dateTimeAdd('2026-03-19 00:00:00Z', 'P2D')
